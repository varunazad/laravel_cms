                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="media-upload-btn-wrapper">
                                            ...
                                            <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="{{__('Select Blog Image')}}" data-modaltitle="{{__('Upload Blog Image')}}" data-toggle="modal" data-target="#media_upload_modal">
                                                {{__('Upload Image')}}
                                            </button>
                                        </div>
