                                            ...
                                            <div class="card">
                                                ...
                                                <div id="paypal_settings_content" class="collapse"  data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="paypal_app_client_id">{{__('Paypal App Client ID')}}</label>
                                                            <input type="text" name="paypal_app_client_id"  class="form-control" value="{{get_static_option('paypal_app_client_id')}}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="paypal_app_secret">{{__('Paypal App Secret')}}</label>
                                                            <input type="text" name="paypal_app_secret" class="form-control" value="{{get_static_option('paypal_app_secret')}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card">
                                                ...
                                                <div id="paytm_settings_content" class="collapse"  data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="paytm_test_mode"><strong>{{__('Enable Test Mode')}}</strong></label>
                                                            <label class="switch">
                                                                <input type="checkbox" name="paytm_test_mode"  @if(!empty(get_static_option('paytm_test_mode'))) checked @endif >
                                                                <span class="slider onff"></span>
                                                            </label>
                                                        </div>
                                                        <div class="form-group">
