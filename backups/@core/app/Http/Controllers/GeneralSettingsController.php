...
class GeneralSettingsController extends Controller
{
    ...
    public function update_payment_settings(Request $request)
    {
        ...
        $env_val['PAYTM_ENVIRONMENT'] = !empty($request->paytm_test_mode) ? 'local' : 'live';
        $env_val['PAYTM_MERCHANT_ID'] = $request->paytm_merchant_key ?: 'Digita57697814558795';
        $env_val['PAYTM_MERCHANT_KEY'] = '"'.$request->paytm_merchant_mid .'"'?: 'dv0XtmsPYpewNag&';
        ...
        setEnvValue([
            ...
            'PAYPAL_MODE' => $env_val['PAYPAL_MODE'],
            'PAYPAL_CLIENT_ID' => $env_val['PAYPAL_CLIENT_ID'],
            'PAYPAL_SECRET' => $env_val['PAYPAL_SECRET'],
            'PAYTM_MERCHANT_ID' => $env_val['PAYTM_MERCHANT_ID'],
            'PAYTM_MERCHANT_KEY' => $env_val['PAYTM_MERCHANT_KEY'],
        ]);
