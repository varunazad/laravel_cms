...
class HomePageController extends Controller
{
    ...
    public function home_01_update_section_manage(Request $request){
        ...
        $this->validate($request,[
            ...
            update_static_option('home_page_quote_faq_section_status',$request->home_page_quote_faq_section_status);
            update_static_option('home_page_video_section_status',$request->home_page_video_section_status);
            update_static_option('home_page_expertice_section_status',$request->home_page_expertice_section_status);
