                                            ...
                                            <div class="card">
                                                ...
                                                <div id="paypal_settings_content" class="collapse"  data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="paypal_app_client_id"><?php echo e(__('Paypal App Client ID')); ?></label>
                                                            <input type="text" name="paypal_app_client_id"  class="form-control" value="<?php echo e(get_static_option('paypal_app_client_id')); ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="paypal_app_secret"><?php echo e(__('Paypal App Secret')); ?></label>
                                                            <input type="text" name="paypal_app_secret" class="form-control" value="<?php echo e(get_static_option('paypal_app_secret')); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card">
                                                ...
                                                <div id="paytm_settings_content" class="collapse"  data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="paytm_test_mode"><strong><?php echo e(__('Enable Test Mode')); ?></strong></label>
                                                            <label class="switch">
                                                                <input type="checkbox" name="paytm_test_mode"  <?php if(!empty(get_static_option('paytm_test_mode'))): ?> checked <?php endif; ?> >
                                                                <span class="slider onff"></span>
                                                            </label>
                                                        </div>
                                                        <div class="form-group">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/nexelit/@core/resources/views/backend/general-settings/payment-gateway.blade.php ENDPATH**/ ?>