...
<div class="portfolio-home-header-area">
    ...
    <div class="right-image">
        <?php echo render_image_markup_by_attachment_id(get_static_option('portfolio_home_page_right_image')); ?>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="header-inner">
                    <span class="subtitle"><?php echo e(get_static_option('portfolio_home_page_'.$user_select_lang_slug.'_subtitle')); ?></span>
                    <h1 class="title"><?php echo e(get_static_option('portfolio_home_page_'.$user_select_lang_slug.'_title')); ?></h1>
                    <h6 class="profession"><?php echo e(get_static_option('portfolio_home_page_'.$user_select_lang_slug.'_profession')); ?></h6>
                    <div class="description"><?php echo get_static_option('portfolio_home_page_'.$user_select_lang_slug.'_description'); ?></div>
                    <div class="btn-wrapper margin-top-40">
                        <a href="<?php echo e(get_static_option('portfolio_home_page_button_url')); ?>"
                           class="portfolio-btn"><?php echo e(get_static_option('portfolio_home_page_'.$user_select_lang_slug.'_button_text')); ?>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="left-content-area">
                        <div class="img-wrapper">
                            ...
                            <?php echo render_image_markup_by_attachment_id(get_static_option('portfolio_about_section_left_image')); ?>
                ...
                <div class="col-lg-6">
                    <div class="right-content-area">
                        <span class="subtitle"><?php echo e(get_static_option('portfolio_about_section_'.$user_select_lang_slug.'_subtitle')); ?></span>
                        <h3 class="title"><?php echo e(get_static_option('portfolio_about_section_'.$user_select_lang_slug.'_title')); ?></h3>
                        <div class="description">
                            <?php echo get_static_option('portfolio_about_section_'.$user_select_lang_slug.'_description'); ?>
                        ...
                        <div class="button-wrap margin-top-40">
                            <a href="<?php echo e(get_static_option('portfolio_about_section_button_one_url')); ?>"
                               class="portfolio-btn"><?php echo e(get_static_option('portfolio_about_section_'.$user_select_lang_slug.'_button_one_text')); ?>

                                <i class="<?php echo e(get_static_option('portfolio_about_section_button_one_icon')); ?>"></i></a>
                            <a href="<?php echo e(get_static_option('portfolio_about_section_button_two_url')); ?>"
                               class="portfolio-btn blank"><?php echo e(get_static_option('portfolio_about_section_'.$user_select_lang_slug.'_button_two_text')); ?>

                                <i class="<?php echo e(get_static_option('portfolio_about_section_button_two_icon')); ?>"></i></a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php if(!empty(get_static_option('home_page_expertice_section_status'))): ?>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title white text-center margin-bottom-60">
                    <span class="subtitle"><?php echo e(get_static_option('portfolio_expertice_section_'.$user_select_lang_slug.'_subtitle')); ?></span>
                    <h2 class="title"><?php echo e(get_static_option('portfolio_expertice_section_'.$user_select_lang_slug.'_title')); ?></h2>
                </div>
            </div>
        </div>
        <div class="row">
...
<div class="what-we-offer-area dark-section-bg-two padding-top-115 padding-bottom-90">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title white text-center margin-bottom-60">
                    <span class="subtitle"><?php echo e(get_static_option('portfolio_what_we_offer_section_'.$user_select_lang_slug.'_subtitle')); ?></span>
                    <h2 class="title"><?php echo e(get_static_option('portfolio_what_we_offer_section_'.$user_select_lang_slug.'_title')); ?></h2>
                </div>
            </div>
        </div>
        <div class="row">
...
<div class="what-we-offer-area dark-section-bg-three padding-top-115 padding-bottom-90">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title white text-center margin-bottom-60">
                    <span class="subtitle"><?php echo e(get_static_option('portfolio_recent_work_section_'.$user_select_lang_slug.'_subtitle')); ?></span>
                    <h2 class="title"><?php echo e(get_static_option('portfolio_recent_work_section_'.$user_select_lang_slug.'_title')); ?></h2>
                </div>
            </div>
            <div class="col-lg-12">
                ...
                <div class="btn-wrapper text-center margin-top-40">
                    <a href="<?php echo e(route('frontend.work')); ?>" class="portfolio-btn"><?php echo e(get_static_option('portfolio_recent_work_section_'.$user_select_lang_slug.'_button_text')); ?> <i class="fas fa-long-arrow-alt-right"></i></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-between">
            <div class="col-lg-8">
                <div class="left-content-wrap">
                    <h4 class="title"><?php echo e(get_static_option('portfolio_cta_section_'.$user_select_lang_slug.'_title')); ?></h4>
                    <p class="description"><?php echo e(get_static_option('portfolio_cta_section_'.$user_select_lang_slug.'_description')); ?></p>
                    <div class="btn-wrapper">
                        <a href="<?php echo e(get_static_option('portfolio_cta_section_button_url')); ?>" class="portfolio-btn"><?php echo e(get_static_option('portfolio_cta_section_'.$user_select_lang_slug.'_button_text')); ?> <i class="<?php echo e(get_static_option('portfolio_cta_section_button_icon')); ?>"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="right-content-wrap">
                    <div class="img-wrap">
                        <?php echo render_image_markup_by_attachment_id(get_static_option('portfolio_cta_section_right_image')); ?>
...
<div class="portfolio-testimonial-area dark-section-bg-three padding-top-115 padding-bottom-115">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title white text-center margin-bottom-60">
                    <span class="subtitle"><?php echo e(get_static_option('portfolio_testimonial_section_'.$user_select_lang_slug.'_subtitle')); ?></span>
                    <h2 class="title"><?php echo e(get_static_option('portfolio_testimonial_section_'.$user_select_lang_slug.'_title')); ?></h2>
                </div>
            </div>
        </div>
        <div class="row ">
...
<div class="portfolio-news-area dark-section-bg-two padding-top-115 padding-bottom-115">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title white text-center margin-bottom-60">
                    <span class="subtitle"><?php echo e(get_static_option('portfolio_news_section_'.$user_select_lang_slug.'_subtitle')); ?></span>
                    <h2 class="title"><?php echo e(get_static_option('portfolio_news_section_'.$user_select_lang_slug.'_title')); ?></h2>
                </div>
            </div>
        </div>
        <div class="row">
                        ...
                        <?php $__currentLoopData = $all_blog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="single-portfolio-blog-grid">
                                ...
                                <div class="content">
                                    ...
                                    <a class="readmore" href="<?php echo e(route('frontend.blog.single',$data->slug)); ?>"><?php echo e(get_static_option('portfolio_news_section_'.$user_select_lang_slug.'_button_text')); ?></a>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
...
<?php endif; ?><?php /**PATH /home/xgenxchi/public_html/laravel/nexelit/beta/@core/resources/views/frontend/home-pages/home-05.blade.php ENDPATH**/ ?>