...
<div class="stripe-payment-wrapper">
    <div class="srtipe-payment-inner-wrapper">
        ...
        <div class="btn-wrapper">
            <button class="submit-btn"  id="payment_submit_btn"><?php echo e(__('Pay')); ?> <?php echo e(amount_with_currency_symbol($stripe_data['price'])); ?></button>
        </div>
    </div>
</div>
...
<?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/nexelit/@core/resources/views/frontend/payment/stripe.blade.php ENDPATH**/ ?>