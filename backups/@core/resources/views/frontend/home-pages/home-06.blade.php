        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title desktop-center margin-bottom-60">
                    <span class="subtitle">{{get_static_option('logistic_what_we_offer_section_'.$user_select_lang_slug.'_subtitle')}}</span>
                    <h2 class="title">{{get_static_option('logistic_what_we_offer_section_'.$user_select_lang_slug.'_title')}}</h2>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="logistics-single-what-we-cover-item margin-bottom-30">
                        ...
                        <div class="content">
                            ...
                            <p>{{$data->excerpt}}</p>
                            <a href="{{route('frontend.services.single', $data->slug)}}" class="readmore">{{get_static_option('logistic_what_we_offer_section_'.$user_select_lang_slug.'_button_text')}} <i class="fas fa-long-arrow-alt-right"></i></a>
                        </div>
                    </div>
                </div>
            @endforeach
...
@endif
@if(!empty(get_static_option('home_page_video_section_status')))
<div class="logistic-video-area-wrap">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="logistic-video-wrap">
                    {!! render_image_markup_by_attachment_id(get_static_option('portfolio_video_section_background_image'),'','full') !!}
                    <a href="{{get_static_option('portfolio_video_section_video_url')}}" class="video-play-btn"><i class="fas fa-play"></i></a>
                </div>
            </div>
        </div>
    </div>
...
{!! render_background_image_markup_by_attachment_id(get_static_option('portfolio_counterup_section_background_image')) !!}
>
    <div class="container">
        <div class="row">
...
<div class="logistic-project-area padding-top-115 padding-bottom-90">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title desktop-center margin-bottom-60">
                    <span class="subtitle">{{get_static_option('logistic_project_section_'.$user_select_lang_slug.'_subtitle')}}</span>
                    <h2 class="title">{{get_static_option('logistic_project_section_'.$user_select_lang_slug.'_title')}}</h2>
                </div>
            </div>
        </div>
        <div class="row">
...
@endif
@if(!empty(get_static_option('home_page_quote_faq_section_status')))
<div class="quote-and-faq section-white-bg-one padding-top-115 padding-bottom-115">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="logistic-get-quote">
                    <span class="subtitle">{{get_static_option('logistic_quote_section_'.$user_select_lang_slug.'_subtitle')}}</span>
                    <h4 class="title">{{get_static_option('logistic_quote_section_'.$user_select_lang_slug.'_title')}}</h4>
                    <form action="" class="logistic-quote-form">
                        ...
                        <div class="form-group">
                            <button type="submit" class="logistics-btn">{{get_static_option('logistic_quote_section_'.$user_select_lang_slug.'_button_text')}}</button>
                        </div>
                    </form>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="logistic-faq-wrapper">
                    <span class="subtitle">{{get_static_option('logistic_faq_section_'.$user_select_lang_slug.'_subtitle')}}</span>
                    <h4 class="title">{{get_static_option('logistic_faq_section_'.$user_select_lang_slug.'_title')}}</h4>
...
<div class="logistic-testimonial-area padding-top-115 padding-bottom-120">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title desktop-center margin-bottom-60">
                    <span class="subtitle">{{get_static_option('logistic_testimonial_section_'.$user_select_lang_slug.'_subtitle')}}</span>
                    <h2 class="title">{{get_static_option('logistic_testimonial_section_'.$user_select_lang_slug.'_title')}}</h2>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
...
<div class="logistic-news-area padding-bottom-120">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title desktop-center margin-bottom-60">
                    <span class="subtitle">{{get_static_option('logistic_news_section_'.$user_select_lang_slug.'_subtitle')}}</span>
                    <h2 class="title">{{get_static_option('logistic_news_section_'.$user_select_lang_slug.'_title')}}</h2>
                </div>
            </div>
        </div>
        <div class="row">
