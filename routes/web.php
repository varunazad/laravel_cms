...
Route::group(['middleware' => ['setlang','globalVariable','donation_module_check']],function (){
    ...
    Route::get('/donation-stripe/pay','DonationLogController@stripe_success')->name('frontend.donation.stripe.success');
...
Route::group(['middleware' => ['setlang','globalVariable','product_module_check']],function (){
    ...
    Route::get('/product-stripe/pay','ProductOrderController@stripe_success')->name('frontend.product.stripe.success');
...
Route::group(['middleware' => ['setlang','globalVariable','event_module_check']],function (){
    ...
    Route::get('/event-stripe/pay','EventPaymentLogsController@stripe_success')->name('frontend.event.stripe.success');
...
Route::group(['middleware' => ['setlang','globalVariable','job_module_check']],function (){
    ...
    Route::get('/job-stripe/pay','JobPaymentController@stripe_success')->name('frontend.job.stripe.success');
...
Route::prefix('admin-home')->middleware(['home_variant_manage_check'])->group(function (){
    ...
    Route::get('/appearance-settings/home-variant',"AdminDashboardController@home_variant")->name('admin.home.variant');
    Route::post('/appearance-settings/home-variant',"AdminDashboardController@update_home_variant");
});
...
Route::prefix('admin-home')->middleware(['home_page_manage_check'])->group(function (){
    ...
    //portfolio home page manage
    Route::get('/home-05/header','PortfolioHomePageController@header_area')->name('admin.home05.header');
    Route::post('/home-05/header','PortfolioHomePageController@update_header_area');
    Route::get('/home-05/about','PortfolioHomePageController@about_area')->name('admin.home05.about');
    Route::post('/home-05/about','PortfolioHomePageController@update_about_area');
    Route::get('/home-05/expertises','PortfolioHomePageController@expertises_area')->name('admin.home05.expertises');
    Route::post('/home-05/expertises','PortfolioHomePageController@update_expertises_area');
    Route::get('/home-05/what-we-offer','PortfolioHomePageController@what_we_offer_area')->name('admin.home05.what.offer.area');
    Route::post('/home-05/what-we-offer','PortfolioHomePageController@update_what_we_offer_area');
    Route::get('/home-05/recent-work','PortfolioHomePageController@recent_work_area')->name('admin.home05.recent.work.area');
    Route::post('/home-05/recent-work','PortfolioHomePageController@update_recent_work_area');
    Route::get('/home-05/cta-area','PortfolioHomePageController@cta_area')->name('admin.home05.cta.area');
    Route::post('/home-05/cta-area','PortfolioHomePageController@update_cta_area');
    Route::get('/home-05/testimonial-area','PortfolioHomePageController@testimonial_area')->name('admin.home05.testimonial.area');
    Route::post('/home-05/testimonial-area','PortfolioHomePageController@update_testimonial_area');
    Route::get('/home-05/news-area','PortfolioHomePageController@news_area')->name('admin.home05.news.area');
    Route::post('/home-05/news-area','PortfolioHomePageController@update_news_area');
    //logistics home page manage
    Route::get('/home-06/header','LogisticsHomePageController@header_area')->name('admin.home06.header');
    Route::post('/home-06/header','LogisticsHomePageController@update_header_area');
    Route::get('/home-06/what-we-offer','LogisticsHomePageController@what_we_offer_area')->name('admin.home06.what.offer');
    Route::post('/home-06/what-we-offer','LogisticsHomePageController@update_what_we_offer_area');
    Route::get('/home-06/video-area','LogisticsHomePageController@video_area')->name('admin.home06.video.area');
    Route::post('/home-06/video-area','LogisticsHomePageController@update_video_area');
    Route::get('/home-06/counterup-area','LogisticsHomePageController@counterup_area')->name('admin.home06.counterup.area');
    Route::post('/home-06/counterup-area','LogisticsHomePageController@update_counterup_area');
    Route::get('/home-06/project-area','LogisticsHomePageController@project_area')->name('admin.home06.project.area');
    Route::post('/home-06/project-area','LogisticsHomePageController@update_project_area');
    Route::get('/home-06/quote-faq-area','LogisticsHomePageController@quote_faq_area')->name('admin.home06.quote.faq.area');
    Route::post('/home-06/quote-faq-area','LogisticsHomePageController@update_quote_faq_area');
    Route::get('/home-06/testimonial-area','LogisticsHomePageController@testimonial_area')->name('admin.home06.testimonial.area');
    Route::post('/home-06/testimonial-area','LogisticsHomePageController@update_testimonial_area');
    Route::get('/home-06/news-area','LogisticsHomePageController@news_area')->name('admin.home06.news.area');
    Route::post('/home-06/news-area','LogisticsHomePageController@update_news_area');
});
...
//general settings
Route::prefix('admin-home/appearance-settings')->middleware(['general_settings_check'])->group(function () {
    //navbar settings
